...
public class Util {
    ...
    public static final String booksDataFileName = "src\\main\\resources\\books.json";
    ...
    public static List<Book> getBooks() throws IOException {
        return newMapper().readValue(new File(booksDataFileName), new TypeReference<>() {
        });
    }
